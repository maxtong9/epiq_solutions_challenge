/* File: gpio_lib.hpp - Header only library
Description: Provides a mock up of an API to control GPIO pins from Linux
...
Parameters: port_id is the ID of the GPIO port, pin_id is a value from 0-7, and
